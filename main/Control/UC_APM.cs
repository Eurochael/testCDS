...
namespace cds
{
    public partial class UC_APM : UserControl
    {
        ...
        public void UI_Change()
        {
            ...
            try
            {
                ...
                //고객 요청에 따른 암모니아 -> 과수 순서로 View 변경
                if(Program.tank[(int)tank_class.enum_tank_type.TANK_A].volume_name.ToString().Split('/').Length >=2)
                {
                    lbl_mixing_volume_name_a.Text = Program.tank[(int)tank_class.enum_tank_type.TANK_A].volume_name.ToString().Split('/')[1].Trim() + "/"
                        + Program.tank[(int)tank_class.enum_tank_type.TANK_A].volume_name.ToString().Split('/')[0].Trim() + "/"
                        + Program.tank[(int)tank_class.enum_tank_type.TANK_A].volume_name.ToString().Split('/')[2].Trim();
                    lbl_mixing_volume_ratio_a.Text = Program.tank[(int)tank_class.enum_tank_type.TANK_A].volume_ratio.ToString().Split('/')[1] + "/"
                    + Program.tank[(int)tank_class.enum_tank_type.TANK_A].volume_ratio.ToString().Split('/')[0] + "/"
                    + Program.tank[(int)tank_class.enum_tank_type.TANK_A].volume_ratio.ToString().Split('/')[2];
                }
                else
                {
                ...
                lbl_flow_fm05.Text = string.Format("{0:f2}", Program.main_form.SerialData.FlowMeter_USF500.NH4OH_flow) + "/" + string.Format("{0:f2}", Program.main_form.SerialData.FlowMeter_USF500.NH4OH_totalusage) + "(LPM)";
                ...
                if(view_heater_interlock_value == false)
                {
                    ...
                    lbl_temp_heater_he22.Text = string.Format("{0:f1}", Program.main_form.SerialData.TEMP_CONTROLLER.circulation_heater2.pv) + "℃";
                }
                else
                {
                    if(chk_mv_view.Checked == true)
                    {
                        if(Program.cg_app_info.use_heating_output_mapping_tank == true)
                        {
                            lbl_temp_heater_he21.Text = string.Format("{0:f1}", Program.main_form.SerialData.TEMP_CONTROLLER.tank_a.mv) + "%";
                            lbl_temp_heater_he22.Text = string.Format("{0:f1}", Program.main_form.SerialData.TEMP_CONTROLLER.tank_b.mv) + "%";
                        }
                        else
                        {
                            lbl_temp_heater_he21.Text = string.Format("{0:f1}", Program.main_form.SerialData.TEMP_CONTROLLER.circulation.mv) + "%";
                            lbl_temp_heater_he22.Text = string.Format("{0:f1}", Program.main_form.SerialData.TEMP_CONTROLLER.circulation.mv) + "%";
                        }
                   
                        lbl_temp_heater_he41.Text = string.Format("{0:f1}", Program.main_form.SerialData.TEMP_CONTROLLER.supply_a.mv) + "%";
                        lbl_temp_heater_he42.Text = string.Format("{0:f1}", Program.main_form.SerialData.TEMP_CONTROLLER.supply_b.mv) + "%";
                    }
                    else if (chk_offset_view.Checked == true)
                    {
                        if (Program.cg_app_info.use_heating_output_mapping_tank == true)
                        {
                            lbl_temp_heater_he21.Text = string.Format("{0:f1}", Program.main_form.SerialData.TEMP_CONTROLLER.tank_a.offset) + "℃";
                            lbl_temp_heater_he22.Text = string.Format("{0:f1}", Program.main_form.SerialData.TEMP_CONTROLLER.tank_b.offset) + "℃";
                        }
                        else
                        {
                            lbl_temp_heater_he21.Text = string.Format("{0:f1}", Program.main_form.SerialData.TEMP_CONTROLLER.circulation.offset) + "℃";
                            lbl_temp_heater_he22.Text = string.Format("{0:f1}", Program.main_form.SerialData.TEMP_CONTROLLER.circulation.offset) + "℃";
                        }
                        lbl_temp_heater_he41.Text = string.Format("{0:f1}", Program.main_form.SerialData.TEMP_CONTROLLER.supply_a.offset) + "℃";
                        lbl_temp_heater_he42.Text = string.Format("{0:f1}", Program.main_form.SerialData.TEMP_CONTROLLER.supply_b.offset) + "℃";
                    }
                    else
                    {
                        //SV
                        lbl_temp_heater_he41.Text = string.Format("{0:f1}", Program.main_form.SerialData.TEMP_CONTROLLER.supply_heater_a.sv) + "℃";
                        lbl_temp_heater_he42.Text = string.Format("{0:f1}", Program.main_form.SerialData.TEMP_CONTROLLER.supply_heater_b.sv) + "℃";
                        lbl_temp_heater_he21.Text = string.Format("{0:f1}", Program.main_form.SerialData.TEMP_CONTROLLER.circulation_heater1.sv) + "℃";
                        lbl_temp_heater_he22.Text = string.Format("{0:f1}", Program.main_form.SerialData.TEMP_CONTROLLER.circulation_heater2.sv) + "℃";
                    }
                   
                }
            
                lbl_hdiw_temp.Text = string.Format("{0:f1}", Program.main_form.SerialData.TEMP_CONTROLLER.ts_09.pv) + "℃";
                lbl_concentration.Text = string.Format("{0:f1}", Program.ABB.concentration_2) + "wt%" + System.Environment.NewLine + string.Format("{0:f1}", Program.ABB.concentration_1) + "wt%";
                ...
                lbl_he42.BackColor = Program.schematic_form.BackColor_Tank_By_TempController_status(ref Program.main_form.SerialData.TEMP_CONTROLLER.supply_b);

                if (Program.cg_app_info.use_heating_output_mapping_tank == true)
                {
                    if (Program.IO.DO.Tag[(int)Config_IO.enum_do.CIR_FROM_TANK_A].value == true)
                    {
                        lbl_he21.BackColor = Program.schematic_form.BackColor_Tank_By_TempController_status(ref Program.main_form.SerialData.TEMP_CONTROLLER.tank_a);
                        lbl_he22.BackColor = Program.schematic_form.BackColor_Tank_By_TempController_status(ref Program.main_form.SerialData.TEMP_CONTROLLER.tank_a);
                    }
                    else if (Program.IO.DO.Tag[(int)Config_IO.enum_do.CIR_FROM_TANK_B].value == true)
                    {
                        lbl_he21.BackColor = Program.schematic_form.BackColor_Tank_By_TempController_status(ref Program.main_form.SerialData.TEMP_CONTROLLER.tank_b);
                        lbl_he22.BackColor = Program.schematic_form.BackColor_Tank_By_TempController_status(ref Program.main_form.SerialData.TEMP_CONTROLLER.tank_b);
                    }
                    else
                    {
                        lbl_he21.BackColor = Color.White;
                        lbl_he22.BackColor = Color.White;
                    }
                }
                else
                {
                    lbl_he21.BackColor = Program.schematic_form.BackColor_Tank_By_TempController_status(ref Program.main_form.SerialData.TEMP_CONTROLLER.circulation);
                    lbl_he22.BackColor = Program.schematic_form.BackColor_Tank_By_TempController_status(ref Program.main_form.SerialData.TEMP_CONTROLLER.circulation);
                }
                ...
                else
                {
                    ...
                    lbl_tank_a_concentrate.Text = string.Format("{0:f1}", Program.tank[(int)tank_class.enum_tank_type.TANK_A].concentration_ccss2) + "wt%" + string.Format("{0:f1}", Program.tank[(int)tank_class.enum_tank_type.TANK_A].concentration_ccss1) + "wt%";
                ...
                else
                {
                    ...
                    lbl_tank_b_concentrate.Text = string.Format("{0:f1}", Program.tank[(int)tank_class.enum_tank_type.TANK_B].concentration_ccss2) + "wt%" + ", " + string.Format("{0:f1}", Program.tank[(int)tank_class.enum_tank_type.TANK_B].concentration_ccss1) + "wt%";
                ...
                for (int idx = 0; idx < Program.IO.DI.use_cnt; idx++)
                {
                    switch (idx)
                    {
                        case (int)Config_IO.enum_di.Drain_Pump_On_Level: //Drain Pump On Level
                            ...
                            break;
                        case (int)Config_IO.enum_di.DIKE_LEAK: //bot leak
                            if (Program.IO.DI.Tag[idx].value == true)
                            {
                        ...
                        case (int)Config_IO.enum_di.Drain_Tank_H: //drain Tank h
                            ...
                            break;
                        case (int)Config_IO.enum_di.BOTTOM_VAT_LEAK1: //vat leak
                            if (Program.IO.DI.Tag[idx].value == true)
                            {
                            ...
                            break;
                        case (int)Config_IO.enum_di.TANK_VAT_LEAK: //dike leak
                            if (Program.IO.DI.Tag[idx].value == true)
                            {
                        ...
                        //HDIW Generator
                        case (int)Config_IO.enum_di.HDIW_POWER_ON:
                            if (Program.IO.DI.Tag[idx].value == true)
                            {
                                pnl_status_hdiw_generator_power_on.BackgroundImage = Properties.Resources.LED_GREEN_NONE; ;
                            }
                            else
                            {
                                pnl_status_hdiw_generator_power_on.BackgroundImage = Properties.Resources.LED_GRAY_NONE; ;
                            }
                            break;

                        case (int)Config_IO.enum_di.HDIW_REMOTE_MODE:
                            if (Program.IO.DI.Tag[idx].value == true)
                            {
                                pnl_status_hdiw_generator_remote_mode.BackgroundImage = Properties.Resources.LED_GREEN_NONE; ;
                            }
                            else
                            {
                                pnl_status_hdiw_generator_remote_mode.BackgroundImage = Properties.Resources.LED_GRAY_NONE; ;
                            }
                            break;
                ...
                for (int idx = 0; idx < Program.IO.DO.use_cnt; idx++)
                {
                    switch (idx)
                    {
                        case (int)Config_IO.enum_do.SUPPLY_A_HEATER_PWR_ON: //sup a heater power on
                            ...
                            break;
                        case (int)Config_IO.enum_do.SUPPLY_B_HEATER_PWR_ON: //sup b heater power on
                            ...
                            break;
                        case (int)Config_IO.enum_do.CIRCULATION1_HEATER_PWR_ON: //circulat1 heater power on
                            ...
                            break;
                        case (int)Config_IO.enum_do.CIRCULATION2_HEATER_PWR_ON: //circulat2 heater power on
                            if (Program.IO.DO.Tag[idx].value == true) { btn_heater_he22.ImageOptions.Image = Properties.Resources.heater_on; }
                            else { btn_heater_he22.ImageOptions.Image = Properties.Resources.heater_off; }
                            break;
                        case (int)Config_IO.enum_do.HDIW_REMOTE_START: //circulat2 heater power on
                            if (Program.IO.DO.Tag[idx].value == true)
                            {
                                pnl_status_hdiw_generator_remote_start.BackgroundImage = Properties.Resources.LED_GREEN_NONE;
                            }
                            else
                            {
                                pnl_status_hdiw_generator_remote_start.BackgroundImage = Properties.Resources.LED_GRAY_NONE;
                            }
                            break;
                        ...
                        case (int)Config_IO.enum_do.H2O2_SUPPLY_TANK_B: //h2o2-s tank b
                            ...
                            break;
                        case (int)Config_IO.enum_do.NH4OH_SUPPLY_TANK_A: //nh4oh-s tank a
                            ...
                            break;
                        case (int)Config_IO.enum_do.NH4OH_SUPPLY_TANK_B: //nh4oh-s tank b
                            ...
                            break;
                        case (int)Config_IO.enum_do.HOT_DIW_BY_PASS: //diw by-pass
                            if (Program.IO.DO.Tag[idx].value == true) { btn_valve_av09.ImageOptions.Image = Properties.Resources.valve_3w_h_down_open; }
                            else { btn_valve_av09.ImageOptions.Image = Properties.Resources.valve_3w_h_down_close; }
                            break;
                ...
                for (int idx = 0; idx < Program.IO.AI.use_cnt; idx++)
                {
                    switch (idx)
                    {
                        ...
                        case (int)Config_IO.enum_ai.CIRCULATION_FLOW:
                            ...
                            break;
                        case (int)Config_IO.enum_ai.NH4OH_SUPPLY_FILTER_IN_PRESS:
                            lbl_press_ps05.Text = string.Format("{0:f3}", Program.IO.AI.Tag[idx].value) + " Mpa";
                            break;
                        case (int)Config_IO.enum_ai.NH4OH_SUPPLY_FILTER_OUT_PRESS:
                            lbl_press_ps06.Text = string.Format("{0:f3}", Program.IO.AI.Tag[idx].value) + " Mpa";
                            break;
                        case (int)Config_IO.enum_ai.HOT_DIW_SUPPLY_PRESS:
                        ...
                        case (int)Config_IO.enum_ai.DRAIN_FLOW:
                            ...
                            break;
                        case (int)Config_IO.enum_ai.HDIW_FLOW_MONITORING:
                            lbl_hdiw_flow.Text = string.Format("{0:f1}", Program.IO.AI.Tag[idx].value) + " LPM";
                            break;
                ...
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.HOT_DIW_BY_PASS].value == true)
                {
                    pnl_pip_diw01_1.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_diw01_2.BackColor = Program.schematic_form.Pipe_on_ccss;
                }
                else
                {
                   ...
                   Program.IO.DO.Tag[(int)Config_IO.enum_do.DIW_SUPPLY_TANK_B].value == true)
                    {
                        pnl_pip_diw01_3.BackColor = Program.schematic_form.Pipe_on_ccss;
                    ...
                    Program.IO.DO.Tag[(int)Config_IO.enum_do.H2O2_SUPPLY_TANK_B].value == true)
                {
                    ...
                    if (Program.IO.DO.Tag[(int)Config_IO.enum_do.H2O2_SUPPLY_TANK_A].value == true)
                    {
                        ...
                        pnl_pip_h2o205.BackColor = Program.schematic_form.Pipe_on_ccss;
                    }
                    if (Program.IO.DO.Tag[(int)Config_IO.enum_do.H2O2_SUPPLY_TANK_B].value == true)
                    {
                        ...
                        pnl_pip_h2o208.BackColor = Program.schematic_form.Pipe_on_ccss;
                    }
                }
                ...
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.NH4OH_SUPPLY_TANK_A].value == true ||
                    Program.IO.DO.Tag[(int)Config_IO.enum_do.NH4OH_SUPPLY_TANK_B].value == true)
                {
                    pnl_pip_nh4oh01.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_nh4oh02.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_nh4oh02j.BackColor = Program.schematic_form.Pipe_on_ccss;
                    if (Program.IO.DO.Tag[(int)Config_IO.enum_do.NH4OH_SUPPLY_TANK_A].value == true)
                    {
                        pnl_pip_nh4oh03.BackColor = Program.schematic_form.Pipe_on_ccss;
                        pnl_pip_nh4oh04.BackColor = Program.schematic_form.Pipe_on_ccss;
                        pnl_pip_nh4oh05.BackColor = Program.schematic_form.Pipe_on_ccss;
                    }
                    if (Program.IO.DO.Tag[(int)Config_IO.enum_do.NH4OH_SUPPLY_TANK_B].value == true)
                    {
                        pnl_pip_nh4oh06.BackColor = Program.schematic_form.Pipe_on_ccss;
                        pnl_pip_nh4oh07.BackColor = Program.schematic_form.Pipe_on_ccss;
                        pnl_pip_nh4oh08.BackColor = Program.schematic_form.Pipe_on_ccss;
                    }
                    ...
                    Program.IO.DO.Tag[(int)Config_IO.enum_do.CIR_FROM_TANK_B].value == true)
                {
                    ...
                    if (Program.main_form.SerialData.CIRCULATION_PUMP_CONTROLLER.run_state == true)
                    {
                        ...
                        pnl_pip_cir09_1.BackColor = Program.schematic_form.Pipe_on_circulation;
                        pnl_pip_cir09_2.BackColor = Program.schematic_form.Pipe_on_circulation;
                        pnl_pip_cir09_3.BackColor = Program.schematic_form.Pipe_on_circulation;
                    }
                }
            ...
            try
            {
                ...
                switch (event_btn.Name)
                {
                    ...
                    case "btn_valve_av03": //h2o2-s tank a
                        ...
                        break;
                    case "btn_valve_av04": //h2o2-s tank b
                        idx = (int)Config_IO.enum_do.H2O2_SUPPLY_TANK_B;
                        if (Program.IO.DO.Tag[idx].value == true)
                        {
                        ...
                        break;
                    case "btn_valve_av05": //nh4oh-s tank a
                        idx = (int)Config_IO.enum_do.NH4OH_SUPPLY_TANK_A;
                        if (Program.IO.DO.Tag[idx].value == true)
                        {
                        ...
                        else
                        {
                            ...
                            else if (Program.IO.DO.Tag[(int)Config_IO.enum_do.NH4OH_SUPPLY_TANK_B].value == true)
                            {
                                Program.main_md.Message_By_Application("Cannot Open Valve", frm_messagebox.enum_apptype.Only_OK);
                            }
                        ...
                        break;
                    case "btn_valve_av06": //nh4oh-s tank b
                        idx = (int)Config_IO.enum_do.NH4OH_SUPPLY_TANK_B;
                        if (Program.IO.DO.Tag[idx].value == true)
                        {
                        ...
                        else
                        {
                            ...
                            else if (Program.IO.DO.Tag[(int)Config_IO.enum_do.NH4OH_SUPPLY_TANK_A].value == true)
                            {
                                Program.main_md.Message_By_Application("Cannot Open Valve", frm_messagebox.enum_apptype.Only_OK);
                            }
                            else if (Program.schematic_form.CCSS_Valve_Use_Check_By_Mixing_Rate(enum_ccss.CCSS2) == false)
                        ...
                        break;
                    case "btn_valve_av09": //hot diw by-pass
                        idx = (int)Config_IO.enum_do.HOT_DIW_BY_PASS;
            ...
            try
            {
                ...
                switch (event_btn.Name)
                {
                    case "btn_heater_he21": // circulation1 heater
                        idx = (int)Config_IO.enum_do.CIRCULATION1_HEATER_PWR_ON;
                        if (Program.IO.DO.Tag[idx].value == true)
                        {
                            Program.schematic_form.CIRCULATION_1_HEATER_ON_OFF(false);
                        }
                        ...
                        break;
                    case "btn_heater_he22": // circulation2 heater
                        idx = (int)Config_IO.enum_do.CIRCULATION2_HEATER_PWR_ON;
                    ...
                    case "btn_heater_he42": // supply b heater
                        idx = (int)Config_IO.enum_do.SUPPLY_B_HEATER_PWR_ON;
                        if (Program.IO.DO.Tag[(int)Config_IO.enum_do.SUPPLY_B_HEATER_PWR_ON].value == true)
                        {
                            Program.schematic_form.SUPPLY_B_HEATER_ON_OFF(false);
                        }
                        else
        ...
        {
            Program.FlowMeter_USF500.Message_Command_Apply_CRC_TO_Send(1, 1, Class_FlowMeter_USF500.ch1_totalusage_reset, 3);
            Program.FlowMeter_USF500.Message_Command_Apply_CRC_TO_Send(1, 2, Class_FlowMeter_USF500.ch2_totalusage_reset, 3);
            Program.FlowMeter_USF500.Message_Command_Apply_CRC_TO_Send(2, 1, Class_FlowMeter_USF500.ch1_totalusage_reset, 3);
            Program.FlowMeter_USF500.Message_Command_Apply_CRC_TO_Send(2, 2, Class_FlowMeter_USF500.ch2_totalusage_reset, 3);
            Program.schematic_form.TotalUsage_Reset(Program.tank[(int)tank_class.enum_tank_type.TANK_A]);
            Program.schematic_form.TotalUsage_Reset(Program.tank[(int)tank_class.enum_tank_type.TANK_B]);
        }
        ...
        private void lbl_temp_heater_he22_Click(object sender, EventArgs e)
        {
            if(view_heater_interlock_value == false)
            {
