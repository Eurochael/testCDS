...
namespace cds
{
    public partial class UC_DSP : UserControl
    {
        ...
        public void UI_Change()
        {
            ...
            lbl_flow_fm03.Text = string.Format("{0:f2}", Program.main_form.SerialData.FlowMeter_Sonotec.DSP_flow) + "/" + string.Format("{0:f2}", Program.main_form.SerialData.FlowMeter_Sonotec.DSP_totalusage) + "(LPM)";
            ...
            else
            {
                ...
                lbl_tank_a_concentrate.Text = Program.tank[(int)tank_class.enum_tank_type.TANK_A].concentration_ccss1.ToString() + "wdt%";
            ...
            else
            {
                ...
                lbl_tank_b_concentrate.Text = Program.tank[(int)tank_class.enum_tank_type.TANK_B].concentration_ccss1.ToString() + "wdt%";
            ...
            lbl_concentration.Text = string.Format("{0:f1}", Program.ABB.concentration_1) + " wdt%";
            ...
            for (int idx = 0; idx < Program.IO.DO.use_cnt; idx++)
            {
                switch (idx)
                {
                    ...
                    case (int)Config_IO.enum_do.DIW_SUPPLY_TANK_B: //diw-s tank b
                        ...
                        break;
                    case (int)Config_IO.enum_do.DSP_SUPPLY_TANK_A: //dsp-s tank a
                        ...
                        break;
                    case (int)Config_IO.enum_do.DSP_SUPPLY_TANK_B: //dsp-s tank b
            ...
            //HEATER HE21
            if (Program.main_form.SerialData.Circulation_Thermostat.heater_on == true && Program.occured_alarm_form.most_occured_alarm_level != frm_alarm.enum_level.HEAVY && Program.main_form.serial_port_state[(int)Config_IO.enum_dsp_serial_index.CIRCULATION_THERMOSTAT] == true)
            {
            ...
            //HEATER HE41
            if (Program.main_form.SerialData.Supply_A_Thermostat.heater_on == true && Program.occured_alarm_form.most_occured_alarm_level != frm_alarm.enum_level.HEAVY && Program.main_form.serial_port_state[(int)Config_IO.enum_dsp_serial_index.SUPPLY_A_THERMOSTAT] == true)
            {
            ...
            //HEATER HE42
            if (Program.main_form.SerialData.Supply_B_Thermostat.heater_on == true && Program.occured_alarm_form.most_occured_alarm_level != frm_alarm.enum_level.HEAVY && Program.main_form.serial_port_state[(int)Config_IO.enum_dsp_serial_index.SUPPLY_B_THERMOSTAT] == true)
            {
            ...
            if (Program.IO.DO.Tag[(int)Config_IO.enum_do.DSP_SUPPLY_TANK_A].value == true ||
                Program.IO.DO.Tag[(int)Config_IO.enum_do.DSP_SUPPLY_TANK_B].value == true)
            {
                pnl_pip_dsp01.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_dsp02.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_dsp02j.BackColor = Program.schematic_form.Pipe_on_ccss;
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.DSP_SUPPLY_TANK_A].value == true)
                {
                    pnl_pip_dsp03.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_dsp04.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_dsp05.BackColor = Program.schematic_form.Pipe_on_ccss;
                }
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.DSP_SUPPLY_TANK_B].value == true)
                {
                    pnl_pip_dsp06.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_dsp07.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_dsp08.BackColor = Program.schematic_form.Pipe_on_ccss;
                }
            }
            ...
            try
            {
                ...
                switch (event_btn.Name)
                {
                    ...
                    case "btn_valve_av03": //dsp-s tank a
                        idx = (int)Config_IO.enum_do.DSP_SUPPLY_TANK_A;
                        if (Program.IO.DO.Tag[idx].value == true)
                        {
                        ...
                        else
                        {
                            ...
                            else if (Program.IO.DO.Tag[(int)Config_IO.enum_do.DSP_SUPPLY_TANK_B].value == true)
                            {
                                Program.main_md.Message_By_Application("Cannot Open Valve", frm_messagebox.enum_apptype.Only_OK);
                            }
                    ...
                    case "btn_valve_av04": //dsp-s tank b
                        ...
                        else
                        {
                            ...
                            else if (Program.IO.DO.Tag[(int)Config_IO.enum_do.DSP_SUPPLY_TANK_A].value == true)
                            {
                                Program.main_md.Message_By_Application("Cannot Open Valve", frm_messagebox.enum_apptype.Only_OK);
                            }
                            else if (Program.schematic_form.CCSS_Valve_Use_Check_By_Mixing_Rate(enum_ccss.CCSS1) == false)
        ...
        {
            if (Program.schematic_form.MAIN_RETURN_DRAIN_FORCE_ON == true)
            {
                Program.schematic_form.MAIN_RETURN_DRAIN_FORCE_ON = false;
                Program.ethercat_md.DO_Write_Alone((int)Config_IO.enum_do.MAIN_RETURN_DRAIN, false);
            }
            else
            {
                Program.schematic_form.MAIN_RETURN_DRAIN_FORCE_ON = true;
