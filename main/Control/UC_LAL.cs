...
namespace cds
{
    public partial class UC_LAL : UserControl
    {
        ...
        public void UI_Change()
        {
            ...
            ///SERIAL DATA
            lbl_flow_fm01.Text = string.Format("{0:f2}", Program.main_form.SerialData.FlowMeter_Sonotec.DIW_flow) + "/" + string.Format("{0:f2}", Program.main_form.SerialData.FlowMeter_Sonotec.DIW_totalusage) + "(LPM)";
            lbl_flow_fm03.Text = string.Format("{0:f2}", Program.main_form.SerialData.FlowMeter_Sonotec.LAL_flow) + "/" + string.Format("{0:f2}", Program.main_form.SerialData.FlowMeter_Sonotec.LAL_totalusage) + "(LPM)";
            ...
            lbl_concentration.Text = string.Format("{0:f1}", Program.main_form.SerialData.CS600F.concentration) + " wt%";
            ...
            for (int idx = 0; idx < Program.IO.DO.use_cnt; idx++)
            {
                switch (idx)
                {
                    ...
                    case (int)Config_IO.enum_do.DIW_SUPPLY_TANK_B: //diw-s tank b
                        ...
                        break;
                    case (int)Config_IO.enum_do.LAL_SUPPLY_TANK_A: //lal-s tank a
                        ...
                        break;
                    case (int)Config_IO.enum_do.LAL_SUPPLY_TANK_B: //lal-s tank b
                        ...
                        break;
                    case (int)Config_IO.enum_do.CM_FLUSHING_DIW: //c/m flushing diw
                        if (Program.IO.DO.Tag[idx].value == true) { btn_valve_av09.ImageOptions.Image = Properties.Resources.valve_h_open; }
                        else { btn_valve_av09.ImageOptions.Image = Properties.Resources.valve_h_close; }
                        break;
                    ...
                    case (int)Config_IO.enum_do.CIR_TO_TANK_A: //circuit tank a in
                        if (Program.IO.DO.Tag[idx].value == true) { btn_valve_av23.ImageOptions.Image = Properties.Resources.valve_v_open; }
                        else { btn_valve_av23.ImageOptions.Image = Properties.Resources.valve_v_close; }
                        break;
                    ...
                    case (int)Config_IO.enum_do.SUPPLY_FROM_TANK_A: //supply tank a out
                        if (Program.IO.DO.Tag[idx].value == true) { btn_valve_av41.ImageOptions.Image = Properties.Resources.valve_h_open; }
                        else { btn_valve_av41.ImageOptions.Image = Properties.Resources.valve_h_close; }
                        break;
                    ...
                    case (int)Config_IO.enum_do.TANK_B_DRAIN: //tank b drain
                        ...
                        break;
                    case (int)Config_IO.enum_do.RECLAIM_DRAIN: //Reclaim
                        if (Program.IO.DO.Tag[idx].value == true) { btn_valve_av49.ImageOptions.Image = Properties.Resources.valve_h_open; }
                        else { btn_valve_av49.ImageOptions.Image = Properties.Resources.valve_h_close; }
                        break;
                    case (int)Config_IO.enum_do.RETURN_RECLAIM_TO_TANK_A: //RETURN_RECLAIM_TO_TANK_A
                        if (Program.IO.DO.Tag[idx].value == true) { btn_valve_av47.ImageOptions.Image = Properties.Resources.valve_v_open; }
                        else { btn_valve_av47.ImageOptions.Image = Properties.Resources.valve_v_close; }
                        break;
                    case (int)Config_IO.enum_do.RETURN_RECLAIM_TO_TANK_B: //RETURN_RECLAIM_TO_TANK_B
                        if (Program.IO.DO.Tag[idx].value == true) { btn_valve_av48.ImageOptions.Image = Properties.Resources.valve_v_open; }
                        else { btn_valve_av48.ImageOptions.Image = Properties.Resources.valve_v_close; }
                        break;

                    //case (int)Config_IO.enum_do.: //reclaim A
                    //    if (Program.IO.DO.Tag[idx].value == true) { btn_valve_av47.ImageOptions.Image = Properties.Resources.valve_v_open; }
                    //    else { btn_valve_av47.ImageOptions.Image = Properties.Resources.valve_v_close; }
                    //    break;
                    //case (int)Config_IO.enum_do.: //reclaim B
                    //    if (Program.IO.DO.Tag[idx].value == true) { btn_valve_av48.ImageOptions.Image = Properties.Resources.valve_v_open; }
                    //    else { btn_valve_av48.ImageOptions.Image = Properties.Resources.valve_v_close; }
                    //    break;
            ...
            for (int idx = 0; idx < Program.IO.AI.use_cnt; idx++)
            {
                switch (idx)
                {
                    ...
                    case (int)Config_IO.enum_ai.DIW_SUPPLY_PRESS:
                        ...
                        break;
                    case (int)Config_IO.enum_ai.DSP_SUPPLY_FILTER_IN_PRESS:
                        lbl_press_ps03.Text = string.Format("{0:f3}", Program.IO.AI.Tag[idx].value) + " Mpa";
                        break;
                    case (int)Config_IO.enum_ai.DSP_SUPPLY_FILTER_OUT_PRESS:
                    ...
                    case (int)Config_IO.enum_ai.LAL_SUPPLY_FILTER_IN_PRESS:
                        lbl_press_ps03.Text = string.Format("{0:f3}", Program.IO.AI.Tag[idx].value) + " Mpa";
                        break;
                    case (int)Config_IO.enum_ai.LAL_SUPPLY_FILTER_OUT_PRESS:
                        lbl_press_ps04.Text = string.Format("{0:f3}", Program.IO.AI.Tag[idx].value) + " Mpa";
                        break;

                    case (int)Config_IO.enum_ai.RECLAIM_FILTER_IN_PRESS:
                        lbl_press_ps50.Text = string.Format("{0:f3}", Program.IO.AI.Tag[idx].value) + " Mpa";
                        break;
                    case (int)Config_IO.enum_ai.RECLAIM_FILTER_OUT_PRESS:
                        lbl_press_ps51.Text = string.Format("{0:f3}", Program.IO.AI.Tag[idx].value) + " Mpa";
                        break;
                }
            }
            ...
            //Serial
            //HEATER HE21
            if (Program.main_form.SerialData.Circulation_Thermostat.heater_on == true && Program.occured_alarm_form.most_occured_alarm_level != frm_alarm.enum_level.HEAVY && Program.main_form.serial_port_state[(int)Config_IO.enum_lal_serial_index.CIRCULATION_THERMOSTAT] == true)
            //Program.main_form.serial_port_state[(int)Config_IO.enum_dsp_serial_index.CIRCULATION_THERMOSTAT] == true
            {
            ...
            //HEATER HE41
            if (Program.main_form.SerialData.Supply_A_Thermostat.heater_on == true && Program.occured_alarm_form.most_occured_alarm_level != frm_alarm.enum_level.HEAVY && Program.main_form.serial_port_state[(int)Config_IO.enum_lal_serial_index.SUPPLY_A_THERMOSTAT] == true)
            {
            ...
            //HEATER HE42
            if (Program.main_form.SerialData.Supply_B_Thermostat.heater_on == true && Program.occured_alarm_form.most_occured_alarm_level != frm_alarm.enum_level.HEAVY && Program.main_form.serial_port_state[(int)Config_IO.enum_lal_serial_index.SUPPLY_B_THERMOSTAT] == true)
            {
            ...
            //BP21
            if (Program.main_form.SerialData.CIRCULATION_PUMP_CONTROLLER.run_state == true && Program.occured_alarm_form.most_occured_alarm_level != frm_alarm.enum_level.HEAVY)
            {
            ...
            if (Program.IO.DO.Tag[(int)Config_IO.enum_do.DIW_SUPPLY_TANK_A].value == true ||
                ...
                Program.IO.DO.Tag[(int)Config_IO.enum_do.CM_FLUSHING_DIW].value == true)
            {
                pnl_pip_diw01.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_diw02.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_concen_flush_01.BackColor = Program.schematic_form.Pipe_on_ccss;
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.DIW_SUPPLY_TANK_A].value == true ||
                    Program.IO.DO.Tag[(int)Config_IO.enum_do.DIW_SUPPLY_TANK_B].value == true)
                {
                    pnl_pip_diw02j.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_diw02_1.BackColor = Program.schematic_form.Pipe_on_ccss;
                    ...
                    if (Program.IO.DO.Tag[(int)Config_IO.enum_do.DIW_SUPPLY_TANK_B].value == true)
                    {
                        ...
                        pnl_pip_diw09.BackColor = Program.schematic_form.Pipe_on_ccss;
                        pnl_pip_diw10.BackColor = Program.schematic_form.Pipe_on_ccss;
                    }
                }
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.CM_FLUSHING_DIW].value == true)
                {

                    pnl_pip_concen_flush_02.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_concen_flush_03.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_concen_flush_04.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_concen_flush_05.BackColor = Program.schematic_form.Pipe_on_ccss;

                    pnl_pip_concen02j.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_concen03.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_concen04.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_concen05.BackColor = Program.schematic_form.Pipe_on_ccss;
                }
            ...
            if (Program.IO.DO.Tag[(int)Config_IO.enum_do.LAL_SUPPLY_TANK_A].value == true ||
                Program.IO.DO.Tag[(int)Config_IO.enum_do.LAL_SUPPLY_TANK_B].value == true)
            {
                pnl_pip_lal01.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_lal02.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_lal02j.BackColor = Program.schematic_form.Pipe_on_ccss;
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.LAL_SUPPLY_TANK_A].value == true)
                {
                    pnl_pip_lal03.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_lal04.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_lal05.BackColor = Program.schematic_form.Pipe_on_ccss;
                }
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.LAL_SUPPLY_TANK_B].value == true)
                {
                    pnl_pip_lal06.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_lal07.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_lal08.BackColor = Program.schematic_form.Pipe_on_ccss;
                }
            }

            //RECLAIM
            if (Program.IO.DO.Tag[(int)Config_IO.enum_do.RECLAIM_DRAIN].value == true)
            {
                pnl_pip_reclaim01.BackColor = Program.schematic_form.Pipe_on_drain;
                pnl_pip_reclaim01j.BackColor = Program.schematic_form.Pipe_on_drain;
                pnl_pip_reclaim01_drain.BackColor = Program.schematic_form.Pipe_on_drain;
                pnl_pip_reclaim02_drain.BackColor = Program.schematic_form.Pipe_on_drain;
            }
            if (Program.IO.DO.Tag[(int)Config_IO.enum_do.RETURN_RECLAIM_TO_TANK_A].value == true || Program.IO.DO.Tag[(int)Config_IO.enum_do.RETURN_RECLAIM_TO_TANK_B].value == true)
            {
                pnl_pip_reclaim01.BackColor = Program.schematic_form.Pipe_on;
                pnl_pip_reclaim01j.BackColor = Program.schematic_form.Pipe_on;
                pnl_pip_reclaim02.BackColor = Program.schematic_form.Pipe_on;
                pnl_pip_reclaim03.BackColor = Program.schematic_form.Pipe_on;
                pnl_pip_reclaim04.BackColor = Program.schematic_form.Pipe_on;
                pnl_pip_reclaim04j.BackColor = Program.schematic_form.Pipe_on;
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.RETURN_RECLAIM_TO_TANK_A].value == true)
                {
                    pnl_pip_reclaim05.BackColor = Program.schematic_form.Pipe_on;
                    pnl_pip_reclaim06.BackColor = Program.schematic_form.Pipe_on;
                    pnl_pip_reclaim07.BackColor = Program.schematic_form.Pipe_on;
                }
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.RETURN_RECLAIM_TO_TANK_B].value == true)
                {
                    pnl_pip_reclaim08.BackColor = Program.schematic_form.Pipe_on;
                    pnl_pip_reclaim09.BackColor = Program.schematic_form.Pipe_on;
                    pnl_pip_reclaim10.BackColor = Program.schematic_form.Pipe_on;
                }
            }
            ...
            if (Program.IO.DO.Tag[(int)Config_IO.enum_do.MAIN_RETURN_SAMPLE_1].value == true)
            {
                if (pnl_pip_return08.BackColor == Program.schematic_form.Pipe_on)
                {
                    ...
                    pnl_pip_concen02j.BackColor = Program.schematic_form.Pipe_on;
            ...
            if (Program.IO.DO.Tag[(int)Config_IO.enum_do.MAIN_RETURN_SAMPLE_2].value == true)
            {
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.RETURN_SAMPLE_TO_TANK_A].value == true)
                {
                    ...
                    pnl_pip_concen07j.BackColor = Program.schematic_form.Pipe_on;
            ...
            if (Program.IO.DO.Tag[(int)Config_IO.enum_do.RETURN_SAMPLE_TO_TANK_B].value == true)
            {
                pnl_pip_concen13.BackColor = Program.schematic_form.Pipe_on;
            }
            ...
            try
            {
                ...
                switch (event_btn.Name)
                {
                    ...
                    case "btn_valve_av02": //diw-s tank b
                        ...
                        break;
                    case "btn_valve_av03": //lal-s tank a
                        idx = (int)Config_IO.enum_do.LAL_SUPPLY_TANK_A;
                        if (Program.IO.DO.Tag[idx].value == true)
                        {
                        ...
                        else
                        {
                            ...
                            else if (Program.IO.DO.Tag[(int)Config_IO.enum_do.LAL_SUPPLY_TANK_B].value == true)
                            {
                                Program.main_md.Message_By_Application("Cannot Open Valve", frm_messagebox.enum_apptype.Only_OK);
                            }
                        ...
                        break;
                    case "btn_valve_av04": //lal-s tank b
                        idx = (int)Config_IO.enum_do.LAL_SUPPLY_TANK_B;
                        if (Program.IO.DO.Tag[idx].value == true)
                        {
                        ...
                        else
                        {
                            ...
                            else if (Program.IO.DO.Tag[(int)Config_IO.enum_do.LAL_SUPPLY_TANK_A].value == true)
                            {
                                Program.main_md.Message_By_Application("Cannot Open Valve", frm_messagebox.enum_apptype.Only_OK);
                            }
                            else if (Program.schematic_form.CCSS_Valve_Use_Check_By_Mixing_Rate(enum_ccss.CCSS1) == false)
                        ...
                        break;
                    case "btn_valve_av09": //c/m flushing diw
                        idx = (int)Config_IO.enum_do.CM_FLUSHING_DIW;
                    ...
                    case "btn_valve_av33": //concentration return tank
                        ...
                        {
                            if (Program.IO.DO.Tag[(int)Config_IO.enum_do.CM_FLUSHING_DIW].value == false)
                            {
                                Program.ethercat_md.DO_Write_Alone(idx, true);
                            }
                            else
                            {
                                Program.main_md.Message_By_Application("Cannot Open Valve, CM Flushing DIW Used", frm_messagebox.enum_apptype.Only_OK);
                            }
                    ...
                    case "btn_valve_av45": //tank a drain
                        ...
                        break;
                    case "btn_valve_av47": //Reclaim Return to A
                        idx = (int)Config_IO.enum_do.RETURN_RECLAIM_TO_TANK_A;
                        if (Program.IO.DO.Tag[idx].value == true) { Program.ethercat_md.DO_Write_Alone(idx, false); }
                        else
                        {
                            Program.ethercat_md.DO_Write_Alone(idx, true);
                        ...
                        break;
                    case "btn_valve_av48": //Reclaim Return to B
                        idx = (int)Config_IO.enum_do.RETURN_RECLAIM_TO_TANK_B;
                        if (Program.IO.DO.Tag[idx].value == true) { Program.ethercat_md.DO_Write_Alone(idx, false); }
                        else
                        {
                            Program.ethercat_md.DO_Write_Alone(idx, true);
                        ...
                        break;
                    case "btn_valve_av49": //Reclaim
                        idx = (int)Config_IO.enum_do.RECLAIM_DRAIN;
                        if (Program.IO.DO.Tag[idx].value == true) { Program.ethercat_md.DO_Write_Alone(idx, false); }
                        else
                        {
                            Program.ethercat_md.DO_Write_Alone(idx, true);
                    ...
                    case "btn_valve_av46": //tank b drain
                        ...
                        break;
                    //case "btn_valve_av47": //raclaim A
                    //	idx = (int)Config_IO.enum_do.TANK_A_DRAIN;
                    //	if (Program.IO.DO.Tag[idx].value == true) { Program.ethercat_md.DO_Write_Alone(idx, false); }
                    //	else { Program.ethercat_md.DO_Write_Alone(idx, true); }
                    //	break;
                    //case "btn_valve_av48": //raclaim B
                    //	idx = (int)Config_IO.enum_do.TANK_B_DRAIN;
                    //	if (Program.IO.DO.Tag[idx].value == true) { Program.ethercat_md.DO_Write_Alone(idx, false); }
                    //	else { Program.ethercat_md.DO_Write_Alone(idx, true); }
                    //	break;
        ...
        private void btn_pump_bp21_Click(object sender, EventArgs e)
        {
            ...
            {
                Program.log_md.LogWrite(this.Name + ".btn_pump_bp21_Click." + ex.Message, Module_Log.enumLog.Error, "", Module_Log.enumLevel.ALWAYS);
