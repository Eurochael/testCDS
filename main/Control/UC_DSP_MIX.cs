...
namespace cds
{
    public partial class UC_DSP_MIX : UserControl
    {
        ...
        public void UI_Change()
        {
            ...
            foreach (var x in this.pnl_cmrack.Controls)
            {
                if (x is DoubleBufferedPanel)
                {
                    if (((DoubleBufferedPanel)x).Name.IndexOf("pnl_pip") >= 0)
            ...
            {
                chk_use_auto_drain.Checked = true; chk_use_auto_drain.Enabled = false;
                chk_use_auto_cm_drain.Checked = true; chk_use_auto_cm_drain.Enabled = false;
            }
            else
            {
                chk_use_auto_drain.Enabled = true;
                chk_use_auto_cm_drain.Enabled = true;
            }
            ...
            lbl_flow_fm03.Text = string.Format("{0:f2}", Program.main_form.SerialData.FlowMeter_USF500.H2O2_flow) + "/" + string.Format("{0:f2}", Program.main_form.SerialData.FlowMeter_USF500.H2O2_totalusage) + "(LPM)";
            lbl_flow_fm05.Text = string.Format("{0:f2}", Program.main_form.SerialData.FlowMeter_USF500.H2SO4_flow) + "/" + string.Format("{0:f2}", Program.main_form.SerialData.FlowMeter_USF500.H2SO4_totalusage) + "(LPM)";
            lbl_flow_fm07.Text = string.Format("{0:f2}", Program.main_form.SerialData.FlowMeter_USF500.HF_flow) + "/" + string.Format("{0:f2}", Program.main_form.SerialData.FlowMeter_USF500.HF_totalusage) + "(LPM)";
            ...
            lbl_concen_cm32.Text = string.Format("{0:f1}", Program.main_form.SerialData.HF700.concentration) + " wt%";
            lbl_concen_cm31_h2o2.Text = string.Format("{0:f1}", Program.main_form.SerialData.CS150C.h2o2_concentration) + " wt%";
            lbl_concen_cm31_h2so4.Text = string.Format("{0:f1}", Program.main_form.SerialData.CS150C.h2so4_concentration) + " wt%";
            ...
            else
            {
                ...
                lbl_tank_a_concentrate.Text = string.Format("{0:f1}", Program.tank[(int)tank_class.enum_tank_type.TANK_A].concentration_ccss1) + "," + string.Format("{0:f1}", Program.tank[(int)tank_class.enum_tank_type.TANK_A].concentration_ccss2) + "," + string.Format("{0:f1}", Program.tank[(int)tank_class.enum_tank_type.TANK_A].concentration_ccss3) + "wt%";
            }
            ...
            else
            {
                ...
                lbl_tank_b_concentrate.Text = string.Format("{0:f1}", Program.tank[(int)tank_class.enum_tank_type.TANK_B].concentration_ccss1) + "," + string.Format("{0:f1}", Program.tank[(int)tank_class.enum_tank_type.TANK_B].concentration_ccss2) + "," + string.Format("{0:f1}", Program.tank[(int)tank_class.enum_tank_type.TANK_B].concentration_ccss3) + "wt%";
            }
            ...
            if (Program.Heat_Exchanger.run_state == true)
            {
                ...
                {
                    lbl_heat_exchanger_state.BackColor = Color.Orange;
                }
                else
                {
                    if (Program.IO.DO.Tag[(int)Config_IO.enum_do.CIR_TO_HE_UNIT].value == true)
                    {
                        lbl_heat_exchanger_state.BackColor = Color.Lime;
                    }
                    else
                    {
                        lbl_heat_exchanger_state.BackColor = Color.Yellow;
                    }
                }
            }
            else
            {
                lbl_heat_exchanger_state.BackColor = Color.Gray;
            }
            lbl_heat_exchanger_pv.Text = "PV : " + string.Format("{0:f1}", Program.Heat_Exchanger.pv_temp) + "℃";
            lbl_heat_exchanger_chem_in.Text = "Chem In : " + string.Format("{0:f1}", Program.Heat_Exchanger.chemical_in) + "℃";
            lbl_heat_exchanger_chem_out.Text = "Chem Out : " + string.Format("{0:f1}", Program.Heat_Exchanger.chemical_out) + "";

            lbl_heat_exchanger_press_filter_in.Text = "filter in : " + string.Format("{0:f3}", Program.Heat_Exchanger.filter_in_press) + "";
            lbl_heat_exchanger_press_filter_out.Text = "filter out : " + string.Format("{0:f3}", Program.Heat_Exchanger.filter_out_press) + "";
            lbl_heat_exchanger_press_chem_in.Text = "Chem In : " + string.Format("{0:f3}", Program.Heat_Exchanger.chemical_in_press) + "";
            ...
            for (int idx = 0; idx < Program.IO.DI.use_cnt; idx++)
            {
                switch (idx)
                {
                    ...
                    case (int)Config_IO.enum_di.CIRCULATION_PUMP_LEAK: //circulation pump leak
                        ...
                        break;
                    case (int)Config_IO.enum_di.SUPPLY_A_PUMP_LEAK: //Supply A pump leak
                        if (Program.IO.DI.Tag[idx].value == true)
                        {
                            pnl_leak_bp41.BackgroundImage = Properties.Resources.LED_RED_NONE;
                        }
                        else
                        {
                            pnl_leak_bp41.BackgroundImage = Properties.Resources.LED_GRAY_NONE;
                        }
                        break;
                    case (int)Config_IO.enum_di.SUPPLY_B_PUMP_LEAK: //Supply B pump leak
                        if (Program.IO.DI.Tag[idx].value == true)
                        {
                            pnl_leak_bp42.BackgroundImage = Properties.Resources.LED_RED_NONE;
                        }
                        else
                        {
                            pnl_leak_bp42.BackgroundImage = Properties.Resources.LED_GRAY_NONE;
                        }
                        break;
                    //TANK A LV
                    ...
                    case (int)Config_IO.enum_di.CIRCULATION_PUMP_RIGHT_ON:
                        ...
                        break;
                    case (int)Config_IO.enum_di.CM_DRAIN_PUMP_ON_LEVEL: //CM Drain Pump On Level
                        if (Program.IO.DI.Tag[idx].value == true)
                        {
                            pnl_cm_draintank_on.BackgroundImage = Properties.Resources.LED_GREEN_NONE;
                        }
                        else
                        {
                            pnl_cm_draintank_on.BackgroundImage = Properties.Resources.LED_GRAY_NONE;
                        }
                        break;
                    case (int)Config_IO.enum_di.CM_VAT_LEAK: //CM_VAT_LEAK
                        if (Program.IO.DI.Tag[idx].value == true)
                        {
                            pnl_cm_vat_leak.BackgroundImage = Properties.Resources.LED_RED_NONE;
                        }
                        else
                        {
                            pnl_cm_vat_leak.BackgroundImage = Properties.Resources.LED_GRAY_NONE;
                        }
                        break;
                    case (int)Config_IO.enum_di.CM_DRAIN_TANK_H: //drain Tank h
                        if (Program.IO.DI.Tag[idx].value == true)
                        {
                            pnl_cm_draintank_h.BackgroundImage = Properties.Resources.LED_GREEN_NONE;
                        }
                        else
                        {
                            pnl_cm_draintank_h.BackgroundImage = Properties.Resources.LED_GRAY_NONE;
                        }
                        break;
            ...
            for (int idx = 0; idx < Program.IO.DO.use_cnt; idx++)
            {
                switch (idx)
                {
                    ...
                    case (int)Config_IO.enum_do.Drain_Pump_On: //drain pump on
                        if (Program.IO.DO.Tag[idx].value == true) { btn_pump_bp61.ImageOptions.Image = Properties.Resources.pump_h_on; }
                        else { btn_pump_bp61.ImageOptions.Image = Properties.Resources.pump_h_off; }
                        break;
                    case (int)Config_IO.enum_do.CM_Drain_Pump_On: //CM drain pump on
                        if (Program.IO.DO.Tag[idx].value == true) { btn_pump_bp101.ImageOptions.Image = Properties.Resources.pump_h_on; }
                        else { btn_pump_bp101.ImageOptions.Image = Properties.Resources.pump_h_off; }
                        break;
                    ...
                    case (int)Config_IO.enum_do.DIW_SUPPLY_TANK_B: //diw-s tank b
                        ...
                        break;
                    case (int)Config_IO.enum_do.H2O2_SUPPLY_TANK_A: //h2o2-s tank a
                        ...
                        break;
                    case (int)Config_IO.enum_do.H2O2_SUPPLY_TANK_B: //h2o2-s tank b
                        ...
                        break;
                    case (int)Config_IO.enum_do.H2SO4_SUPPLY_TANK_A: //h2so4-s tank a
                        if (Program.IO.DO.Tag[idx].value == true) { btn_valve_av05.ImageOptions.Image = Properties.Resources.valve_v_open; }
                        else { btn_valve_av05.ImageOptions.Image = Properties.Resources.valve_v_close; }
                        break;
                    case (int)Config_IO.enum_do.H2SO4_SUPPLY_TANK_B: //h2so4-s tank b
                        if (Program.IO.DO.Tag[idx].value == true) { btn_valve_av06.ImageOptions.Image = Properties.Resources.valve_v_open; }
                        else { btn_valve_av06.ImageOptions.Image = Properties.Resources.valve_v_close; }
                        break;
                    case (int)Config_IO.enum_do.HF_SUPPLY_TANK_A: //hf-s tank a
                        if (Program.IO.DO.Tag[idx].value == true) { btn_valve_av07.ImageOptions.Image = Properties.Resources.valve_v_open; }
                        else { btn_valve_av07.ImageOptions.Image = Properties.Resources.valve_v_close; }
                        break;
                    case (int)Config_IO.enum_do.HF_SUPPLY_TANK_B: //hf-s tank b
                        if (Program.IO.DO.Tag[idx].value == true) { btn_valve_av08.ImageOptions.Image = Properties.Resources.valve_v_open; }
                        else { btn_valve_av08.ImageOptions.Image = Properties.Resources.valve_v_close; }
                        break;
                    ...
                    case (int)Config_IO.enum_do.CIR_TO_TANK_A: //circuit tank a in
                        ...
                        break;
                    case (int)Config_IO.enum_do.CIR_TO_HE_UNIT: //circuit HE Exchange a in
                        if (Program.IO.DO.Tag[idx].value == true)
                        {
                            btn_valve_av26.ImageOptions.Image = Properties.Resources.valve_3w_h_up_open2;
                        }
                        else
                        {
                            btn_valve_av26.ImageOptions.Image = Properties.Resources.valve_3w_h_up_close;
                        }
                        break;
                    ...
                    case (int)Config_IO.enum_do.MAIN_RETURN_DRAIN: //chemical return drain
                        ...
                        break;
                    case (int)Config_IO.enum_do.MAIN_RETURN_SAMPLE_1: //chemical return concentration
                        ...
                        break;
                    case (int)Config_IO.enum_do.MAIN_RETURN_SAMPLE_2: //concentration return tank
                    ...
                    case (int)Config_IO.enum_do.Vet_V_V_On: //vat in
                        ...
                        break;
                    case (int)Config_IO.enum_do.CM_Drain_Tank_V_V_On: //dcm rain tank out
                        if (Program.IO.DO.Tag[idx].value == true) { btn_valve_av102.ImageOptions.Image = Properties.Resources.valve_v_open; }
                        else { btn_valve_av102.ImageOptions.Image = Properties.Resources.valve_v_close; }
                        break;
                    case (int)Config_IO.enum_do.CM_VAT_V_V_On: //cm vat in
                        if (Program.IO.DO.Tag[idx].value == true) { btn_valve_av103.ImageOptions.Image = Properties.Resources.valve_v_open; }
                        else { btn_valve_av103.ImageOptions.Image = Properties.Resources.valve_v_close; }
                        break;
                    case (int)Config_IO.enum_do.CM_FLW_V_V: //cm vat in
                        if (Program.IO.DO.Tag[idx].value == true) { btn_valve_av101.ImageOptions.Image = Properties.Resources.valve_h_open; }
                        else { btn_valve_av101.ImageOptions.Image = Properties.Resources.valve_h_close; }
                        break;
                    case (int)Config_IO.enum_do.DIW_TO_CM: //DIW TO C/M
                        if (Program.IO.DO.Tag[idx].value == true) { btn_valve_av15.ImageOptions.Image = Properties.Resources.valve_h_open; }
                        else { btn_valve_av15.ImageOptions.Image = Properties.Resources.valve_h_close; }
                        break;
            ...
            for (int idx = 0; idx < Program.IO.AI.use_cnt; idx++)
            {
                switch (idx)
                {
                    ...
                    case (int)Config_IO.enum_ai.DIW_SUPPLY_PRESS:
                        ...
                        break;
                    case (int)Config_IO.enum_ai.H2O2_SUPPLY_FILTER_IN_PRESS:
                        lbl_press_ps03.Text = string.Format("{0:f3}", Program.IO.AI.Tag[idx].value) + " Mpa";
                        break;
                    case (int)Config_IO.enum_ai.H2O2_SUPPLY_FILTER_OUT_PRESS:
                        lbl_press_ps04.Text = string.Format("{0:f3}", Program.IO.AI.Tag[idx].value) + " Mpa";
                        break;
                    case (int)Config_IO.enum_ai.H2SO4_SUPPLY_FILTER_IN_PRESS:
                        lbl_press_ps05.Text = string.Format("{0:f3}", Program.IO.AI.Tag[idx].value) + " Mpa";
                        break;
                    case (int)Config_IO.enum_ai.H2SO4_SUPPLY_FILTER_OUT_PRESS:
                        lbl_press_ps06.Text = string.Format("{0:f3}", Program.IO.AI.Tag[idx].value) + " Mpa";
                        break;
                    case (int)Config_IO.enum_ai.HF_SUPPLY_FILTER_IN_PRESS:
                        lbl_press_ps07.Text = string.Format("{0:f3}", Program.IO.AI.Tag[idx].value) + " Mpa";
                        break;
                    case (int)Config_IO.enum_ai.HF_SUPPLY_FILTER_OUT_PRESS:
                        lbl_press_ps08.Text = string.Format("{0:f3}", Program.IO.AI.Tag[idx].value) + " Mpa";
                        break;
                    ...
                    case (int)Config_IO.enum_ai.CIRCULATION_THERMOSTAT_PCW_FLOW:
                        ...
                        break;
                    case (int)Config_IO.enum_ai.CM_SOL_PRESS:
                        lbl_press_ps103.Text = string.Format("{0:f3}", Program.IO.AI.Tag[idx].value) + " Mpa";
                        break;
                    case (int)Config_IO.enum_ai.CM_PUMP_PRESS:
                        lbl_press_ps104.Text = string.Format("{0:f3}", Program.IO.AI.Tag[idx].value) + " Mpa";
                        break;
                    case (int)Config_IO.enum_ai.CM_DIW_PRESS:
                        lbl_press_ps101.Text = string.Format("{0:f3}", Program.IO.AI.Tag[idx].value) + " Mpa";
                        break;
                    case (int)Config_IO.enum_ai.CM_SAMPLING_PRESS:
                        lbl_press_ps101.Text = string.Format("{0:f3}", Program.IO.AI.Tag[idx].value) + " Mpa";
                        break;
                    case (int)Config_IO.enum_ai.CM_SAMPLING_FLOW:
                        lbl_flow_fm102.Text = string.Format("{0:f1}", Program.IO.AI.Tag[idx].value) + " LPM";
                        break;
                    case (int)Config_IO.enum_ai.CM_DIW_FLOW:
                        lbl_flow_fm101.Text = string.Format("{0:f1}", Program.IO.AI.Tag[idx].value) + " LPM";
                        break;
                }
            }
            //HEATER HE21
            if (Program.main_form.SerialData.Circulation_Thermostat.heater_on == true && Program.occured_alarm_form.most_occured_alarm_level != frm_alarm.enum_level.HEAVY && Program.main_form.serial_port_state[(int)Config_IO.enum_dsp_mix_serial_index.CIRCULATION_THERMOSTAT] == true)
            {
            ...
            //HEATER HE41
            if (Program.main_form.SerialData.Supply_A_Thermostat.heater_on == true && Program.occured_alarm_form.most_occured_alarm_level != frm_alarm.enum_level.HEAVY && Program.main_form.serial_port_state[(int)Config_IO.enum_dsp_mix_serial_index.SUPPLY_A_THERMOSTAT] == true)
            {
            ...
            //HEATER HE42
            if (Program.main_form.SerialData.Supply_B_Thermostat.heater_on == true && Program.occured_alarm_form.most_occured_alarm_level != frm_alarm.enum_level.HEAVY && Program.main_form.serial_port_state[(int)Config_IO.enum_dsp_mix_serial_index.SUPPLY_B_THERMOSTAT] == true)
            {
              ...
              Program.IO.DO.Tag[(int)Config_IO.enum_do.DIW_SUPPLY_TANK_B].value == true)
            {
                ...
                pnl_pip_diw01j.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_diw02.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_diw03.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_diw03j.BackColor = Program.schematic_form.Pipe_on_ccss;
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.DIW_SUPPLY_TANK_A].value == true)
                {
            ...
            if (Program.IO.DO.Tag[(int)Config_IO.enum_do.DIW_TO_CM].value == true)
            {
                pnl_pip_diw01.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_diw01j.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_diw01_01.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_diw01_02.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_diw01_03.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_diw01_04.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_diw01_05.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_diw01_06.BackColor = Program.schematic_form.Pipe_on_ccss;
            }
            //H2O2-S
            ...
            {
                pnl_pip_h2o201.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_h2o202.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_h2o202j.BackColor = Program.schematic_form.Pipe_on_ccss;
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.H2O2_SUPPLY_TANK_A].value == true)
                {
                    pnl_pip_h2o203.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_h2o204.BackColor = Program.schematic_form.Pipe_on_ccss;
                }
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.H2O2_SUPPLY_TANK_B].value == true)
                {
                    pnl_pip_h2o206.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_h2o207.BackColor = Program.schematic_form.Pipe_on_ccss;
                }
            }

            //H2SO4-S
            if (Program.IO.DO.Tag[(int)Config_IO.enum_do.H2SO4_SUPPLY_TANK_A].value == true ||
                Program.IO.DO.Tag[(int)Config_IO.enum_do.H2SO4_SUPPLY_TANK_B].value == true)
            {
                pnl_pip_h2so401.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_h2so402.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_h2so402j.BackColor = Program.schematic_form.Pipe_on_ccss;
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.H2SO4_SUPPLY_TANK_A].value == true)
                {
                    pnl_pip_h2so403.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_h2so404.BackColor = Program.schematic_form.Pipe_on_ccss;
                }
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.H2SO4_SUPPLY_TANK_B].value == true)
                {
                    pnl_pip_h2so406.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_h2so407.BackColor = Program.schematic_form.Pipe_on_ccss;
                }
            }
            ...
            {
                pnl_pip_dhf01.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_dhf02.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_dhf02j.BackColor = Program.schematic_form.Pipe_on_ccss;
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.HF_SUPPLY_TANK_A].value == true)
                {
                    pnl_pip_dhf03.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_dhf04.BackColor = Program.schematic_form.Pipe_on_ccss;
                }
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.HF_SUPPLY_TANK_B].value == true)
                {
                    pnl_pip_dhf06.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_dhf07.BackColor = Program.schematic_form.Pipe_on_ccss;
                }
            }
                ...
                true)
            {
                ...
                pnl_pip_cda02j.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_cda03.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_cda02_01.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_cda02_01j.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_cda02_01_01.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_cda02_02.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_cda02_03.BackColor = Program.schematic_form.Pipe_on_ccss;

                pnl_pip_cda02_01_02.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_cda02_01_03.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_cda02_01_04.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_cda02_01_05.BackColor = Program.schematic_form.Pipe_on_ccss;

                pnl_pip_cda02_04.BackColor = Program.schematic_form.Pipe_on_ccss;
                pnl_pip_cda02_05.BackColor = Program.schematic_form.Pipe_on_ccss;
                //PUMP
                if (true)
                {
                    pnl_pip_cda01_01.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_cda01_01j.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_cda01_01_01.BackColor = Program.schematic_form.Pipe_on_ccss;
                }
                //DRAIN
                if (true)
                {
                    pnl_pip_cda01_01_01.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_cda01_02.BackColor = Program.schematic_form.Pipe_on_ccss;
                    pnl_pip_cda01_03.BackColor = Program.schematic_form.Pipe_on_ccss;
                }
                ...
                Program.IO.DO.Tag[(int)Config_IO.enum_do.SUPPLY_TO_MAIN_B].value == true)
            {
                ...
                else if (Program.main_form.SerialData.SUPPLY_A_PUMP_CONTROLLER.run_state == true &&
            ...
            //av35,36 공통
            if (pnl_pip_return05.BackColor == Program.schematic_form.Pipe_on)
            {
                ...
                Program.IO.DO.Tag[(int)Config_IO.enum_do.CIR_FROM_TANK_B].value == true)
            {
                ...
                if (Program.main_form.SerialData.CIRCULATION_PUMP_CONTROLLER.run_state == true)
                {
                    ...
                    if (Program.IO.DO.Tag[(int)Config_IO.enum_do.CIR_TO_HE_UNIT].value == false)
                    {
                        pnl_pip_cir09.BackColor = Program.schematic_form.Pipe_on_circulation;
                    }
                    else
                    {
                        pnl_pip_cir08_01.BackColor = Program.schematic_form.Pipe_on_circulation;
                        pnl_pip_cir08_02.BackColor = Program.schematic_form.Pipe_on_circulation;
                        pnl_pip_cir08_03.BackColor = Program.schematic_form.Pipe_on_circulation;
                        pnl_pip_cir08_04.BackColor = Program.schematic_form.Pipe_on_circulation;
                    }
                }
            }
                ...
                && Program.IO.DO.Tag[(int)Config_IO.enum_do.CIR_TO_TANK_B].value == false)
                        {
                            ...
                            pnl_pip_cir13j.BackColor = Program.schematic_form.Pipe_on_circulation;
            ...
            //CM Drain Tank
            if (Program.IO.DO.Tag[(int)Config_IO.enum_do.CM_Drain_Pump_On].value == true)
            {
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.CM_Drain_Tank_V_V_On].value == true)
                {
                    pnl_pip_cm_wastedr_wastedr01.BackColor = Program.schematic_form.Pipe_on;
                    pnl_pip_cm_wastedr_wastedr02.BackColor = Program.schematic_form.Pipe_on;
                    pnl_pip_cm_wastedr_wastedr03.BackColor = Program.schematic_form.Pipe_on;
                    pnl_pip_cm_wastedr_wastedr04.BackColor = Program.schematic_form.Pipe_on;
                }
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.CM_VAT_V_V_On].value == true)
                {
                    pnl_pip_cm_wastedr_wastedr04_01.BackColor = Program.schematic_form.Pipe_on;
                    pnl_pip_cm_wastedr_wastedr04_02.BackColor = Program.schematic_form.Pipe_on;
                }

                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.CM_Drain_Tank_V_V_On].value == true ||
                   Program.IO.DO.Tag[(int)Config_IO.enum_do.CM_VAT_V_V_On].value == true)
                {
                    pnl_pip_cm_wastedr_wastedr04j.BackColor = Program.schematic_form.Pipe_on;
                    pnl_pip_cm_wastedr_wastedr05.BackColor = Program.schematic_form.Pipe_on;
                    pnl_pip_cm_wastedr_wastedr06.BackColor = Program.schematic_form.Pipe_on;
                    pnl_pip_cm_wastedr_wastedr07.BackColor = Program.schematic_form.Pipe_on;
                    pnl_pip_cm_wastedr_wastedr08.BackColor = Program.schematic_form.Pipe_on;
                    pnl_pip_cm_wastedr_wastedr10.BackColor = Program.schematic_form.Pipe_on;
                }
            }

            //CM FLW
            if (Program.IO.DO.Tag[(int)Config_IO.enum_do.CM_FLW_V_V].value == true)
            {
                pnl_pip_concen02_02.BackColor = Program.schematic_form.Pipe_on;
                pnl_pip_concen02_03.BackColor = Program.schematic_form.Pipe_on;
                pnl_pip_concen02_04.BackColor = Program.schematic_form.Pipe_on;
                pnl_pip_concen02_05.BackColor = Program.schematic_form.Pipe_on;
                pnl_pip_concen02_06.BackColor = Program.schematic_form.Pipe_on;
                pnl_pip_concen02_07.BackColor = Program.schematic_form.Pipe_on;
                pnl_pip_concen02_08.BackColor = Program.schematic_form.Pipe_on;
                pnl_pip_concen02_09.BackColor = Program.schematic_form.Pipe_on;

            }



            if (pnl_pip_return08.BackColor == Program.schematic_form.Pipe_on && Program.IO.DO.Tag[(int)Config_IO.enum_do.MAIN_RETURN_SAMPLE_1].value == true)
            {
                pnl_pip_concen02.BackColor = Program.schematic_form.Pipe_on;
                pnl_pip_concen02_01.BackColor = Program.schematic_form.Pipe_on;
                pnl_pip_concen02_10.BackColor = Program.schematic_form.Pipe_on;
                pnl_pip_concen02_11.BackColor = Program.schematic_form.Pipe_on;
            }
            else if (pnl_pip_concen01.BackColor == Program.schematic_form.Pipe_on_circulation && Program.IO.DO.Tag[(int)Config_IO.enum_do.CIR_DRAIN].value == true && Program.IO.DO.Tag[(int)Config_IO.enum_do.MAIN_RETURN_SAMPLE_1].value == false)
            {
                pnl_pip_concen02.BackColor = Program.schematic_form.Pipe_on;
                pnl_pip_concen02_01.BackColor = Program.schematic_form.Pipe_on;
                pnl_pip_concen02_10.BackColor = Program.schematic_form.Pipe_on;
            ...
            else
            {
                ...
                else if (pnl_pip_concen02_11.BackColor == Program.schematic_form.Pipe_on && Program.IO.DO.Tag[(int)Config_IO.enum_do.CIR_DRAIN].value == true)
                {
                    pnl_pip_concen03.BackColor = Program.schematic_form.Pipe_on;
                    pnl_pip_concen04.BackColor = Program.schematic_form.Pipe_on;
                }
            ...
            try
            {
                ...
                switch (event_btn.Name)
                {
                    ...
                    case "btn_valve_av02": //diw-s tank b
                        ...
                        break;
                    case "btn_valve_av03": //h2o2-s tank a
                        idx = (int)Config_IO.enum_do.H2O2_SUPPLY_TANK_A;
                        if (Program.IO.DO.Tag[idx].value == true)
                        {
                        ...
                        else
                        {
                            ...
                            else if (Program.IO.DO.Tag[(int)Config_IO.enum_do.H2O2_SUPPLY_TANK_B].value == true)
                            {
                                Program.main_md.Message_By_Application("Cannot Open Valve", frm_messagebox.enum_apptype.Only_OK);
                            }
                    ...
                    case "btn_valve_av04": //dsp-s tank b
                        idx = (int)Config_IO.enum_do.DSP_SUPPLY_TANK_B;
                        if (Program.IO.DO.Tag[idx].value == true)
                        {
                        ...
                        else
                        {
                            ...
                            else if (Program.IO.DO.Tag[(int)Config_IO.enum_do.H2O2_SUPPLY_TANK_A].value == true)
                            {
                                Program.main_md.Message_By_Application("Cannot Open Valve", frm_messagebox.enum_apptype.Only_OK);
                            }
                            else if (Program.schematic_form.CCSS_Valve_Use_Check_By_Mixing_Rate(enum_ccss.CCSS1) == false)
                        ...
                        break;
                    case "btn_valve_av05": //h2so4-s tank a
                        idx = (int)Config_IO.enum_do.H2SO4_SUPPLY_TANK_A;
                        if (Program.IO.DO.Tag[idx].value == true)
                        {
                            Program.schematic_form.CCSS_INPUT_END_FORCE(tank_class.enum_tank_type.TANK_A, enum_ccss.CCSS2);
                        }
                        else
                        {
                            if (Program.cg_app_info.tank_info[(int)tank_class.enum_tank_type.TANK_A].enable == false)
                            ...
                            else if (Program.IO.DO.Tag[(int)Config_IO.enum_do.H2SO4_SUPPLY_TANK_B].value == true)
                            {
                                Program.main_md.Message_By_Application("Cannot Open Valve", frm_messagebox.enum_apptype.Only_OK);
                            }
                            else if (Program.schematic_form.CCSS_Valve_Use_Check_By_Mixing_Rate(enum_ccss.CCSS2) == false)
                            {
                                Program.main_md.Message_By_Application("Cannot Open Valve(Check Mixing Rate)", frm_messagebox.enum_apptype.Only_OK);
                            }
                            else if (Program.schematic_form.CCSS_INPUT_START_FORCE(tank_class.enum_tank_type.TANK_A, enum_ccss.CCSS2) == false)
                            {
                                Program.main_md.Message_By_Application("Cannot Open Valve", frm_messagebox.enum_apptype.Only_OK);
                            }
                        }
                        break;
                    case "btn_valve_av06": //h2so4-s tank b
                        idx = (int)Config_IO.enum_do.H2SO4_SUPPLY_TANK_B;
                        if (Program.IO.DO.Tag[idx].value == true)
                        {
                            Program.schematic_form.CCSS_INPUT_END_FORCE(tank_class.enum_tank_type.TANK_B, enum_ccss.CCSS2);
                        }
                        else
                        {
                            if (Program.cg_app_info.tank_info[(int)tank_class.enum_tank_type.TANK_B].enable == false)
                            ...
                            else if (Program.IO.DO.Tag[(int)Config_IO.enum_do.H2SO4_SUPPLY_TANK_A].value == true)
                            {
                                Program.main_md.Message_By_Application("Cannot Open Valve", frm_messagebox.enum_apptype.Only_OK);
                            }
                            else if (Program.schematic_form.CCSS_Valve_Use_Check_By_Mixing_Rate(enum_ccss.CCSS2) == false)
                            ...
                            else if (Program.schematic_form.CCSS_INPUT_START_FORCE(tank_class.enum_tank_type.TANK_B, enum_ccss.CCSS2) == false)
                            {
                                Program.main_md.Message_By_Application("Cannot Open Valve", frm_messagebox.enum_apptype.Only_OK);
                            }
                        }
                        break;
                    case "btn_valve_av07": //hf-s tank a
                        idx = (int)Config_IO.enum_do.HF_SUPPLY_TANK_A;
                        if (Program.IO.DO.Tag[idx].value == true)
                        {
                            Program.schematic_form.CCSS_INPUT_END_FORCE(tank_class.enum_tank_type.TANK_A, enum_ccss.CCSS3);
                        }
                        else
                        {
                            if (Program.cg_app_info.tank_info[(int)tank_class.enum_tank_type.TANK_A].enable == false)
                            ...
                            else if (Program.schematic_form.CCSS_Valve_Use_Check_By_Mixing_Rate(enum_ccss.CCSS3) == false)
                            {
                                Program.main_md.Message_By_Application("Cannot Open Valve(Check Mixing Rate)", frm_messagebox.enum_apptype.Only_OK);
                            }
                            else if (Program.schematic_form.CCSS_INPUT_START_FORCE(tank_class.enum_tank_type.TANK_A, enum_ccss.CCSS3) == false)
                            {
                                Program.main_md.Message_By_Application("Cannot Open Valve", frm_messagebox.enum_apptype.Only_OK);
                            }
                        }
                        break;
                    case "btn_valve_av08": //hf-s tank b
                        idx = (int)Config_IO.enum_do.HF_SUPPLY_TANK_B;
                        if (Program.IO.DO.Tag[idx].value == true)
                        {
                            Program.schematic_form.CCSS_INPUT_END_FORCE(tank_class.enum_tank_type.TANK_B, enum_ccss.CCSS3);
                        }
                        else
                        {
                            if (Program.cg_app_info.tank_info[(int)tank_class.enum_tank_type.TANK_B].enable == false)
                            ...
                            else if (Program.schematic_form.CCSS_INPUT_START_FORCE(tank_class.enum_tank_type.TANK_B, enum_ccss.CCSS3) == false)
                            {
                                Program.main_md.Message_By_Application("Cannot Open Valve", frm_messagebox.enum_apptype.Only_OK);
                            }
                        }
                    ...
                    case "btn_valve_av13": //pcw h/e circulation
                        ...
                        break;
                    case "btn_valve_av15": //DIW TO C/M
                        idx = (int)Config_IO.enum_do.DIW_TO_CM;
                        if (Program.IO.DO.Tag[idx].value == true) { Program.ethercat_md.DO_Write_Alone(idx, false); }
                        else
                        {
                            //if (Program.IO.DO.Tag[(int)Config_IO.enum_do.DIW_SUPPLY_TANK_A].value == true)
                            //{
                            //    Program.main_md.Message_By_Application("Cannot Open Valve, DIW Supply Valve Opened", frm_messagebox.enum_apptype.Only_OK);
                            //}
                            //else if (Program.IO.DO.Tag[(int)Config_IO.enum_do.DIW_SUPPLY_TANK_A].value == true)
                            //{
                            //    Program.main_md.Message_By_Application("Cannot Open Valve, DIW Supply Valve Opened", frm_messagebox.enum_apptype.Only_OK);
                    ...
                    case "btn_valve_av25": //circuit drain N/O drain N/C circuit
                        ...
                        break;
                    case "btn_valve_av26": //HE Exchange  N/O Circulation N/C Exchange
                        idx = (int)Config_IO.enum_do.CIR_TO_HE_UNIT;
                        if (Program.IO.DO.Tag[idx].value == true) { Program.ethercat_md.DO_Write_Alone(idx, false); }
                        else
                        {
                            if (Program.IO.DO.Tag[(int)Config_IO.enum_do.CIR_TO_TANK_A].value == true)
                    ...
                    case "btn_valve_av61": //drain tank out
                        ...
                        break;
                    case "btn_valve_av62": //vat
                        idx = (int)Config_IO.enum_do.Vet_V_V_On;
                        if (Program.IO.DO.Tag[idx].value == true) { Program.ethercat_md.DO_Write_Alone(idx, false); }
                        else { Program.ethercat_md.DO_Write_Alone(idx, true); }
                        break;
                    case "btn_valve_av101": //cm drain tank out
                        idx = (int)Config_IO.enum_do.CM_FLW_V_V;
                        if (Program.IO.DO.Tag[idx].value == true) { Program.ethercat_md.DO_Write_Alone(idx, false); }
                        else { Program.ethercat_md.DO_Write_Alone(idx, true); }
                        break;
                    case "btn_valve_av102": //cm drain tank out
                        idx = (int)Config_IO.enum_do.CM_Drain_Tank_V_V_On;
                        if (Program.IO.DO.Tag[idx].value == true) { Program.ethercat_md.DO_Write_Alone(idx, false); }
                        else { Program.ethercat_md.DO_Write_Alone(idx, true); }
                        break;
                    case "btn_valve_av103": //cm vat
                        idx = (int)Config_IO.enum_do.CM_VAT_V_V_On;
                        if (Program.IO.DO.Tag[idx].value == true) { Program.ethercat_md.DO_Write_Alone(idx, false); }
                        else { Program.ethercat_md.DO_Write_Alone(idx, true); }
                        break;
                }
        ...
        private void lbl_heat_exchanger_state_Click(object sender, EventArgs e)
        {
            ...
            if (Program.Heat_Exchanger.heater_on == true)
            {
                Program.schematic_form.CIRCULATION_Heat_Exchanger_ON_OFF(false);
            }
            else
            {
                if (Program.IO.DO.Tag[(int)Config_IO.enum_do.CIR_TO_HE_UNIT].value == false)
                {
                    Program.main_md.Message_By_Application("Circulation Valve Closed", frm_messagebox.enum_apptype.Only_OK);
                }
                else if (Program.IO.DO.Tag[(int)Config_IO.enum_do.CIR_FROM_TANK_A].value == true && Program.IO.DO.Tag[(int)Config_IO.enum_do.CIR_TO_TANK_A].value == false)
                {
                    Program.main_md.Message_By_Application("Cannot Heat Exchanger ON, Circulation Chain Fault", frm_messagebox.enum_apptype.Only_OK);
                }
                else if (Program.IO.DO.Tag[(int)Config_IO.enum_do.CIR_FROM_TANK_B].value == true && Program.IO.DO.Tag[(int)Config_IO.enum_do.CIR_TO_TANK_B].value == false)
                {
                    Program.main_md.Message_By_Application("Cannot Heat Exchanger ON, Circulation Chain Fault", frm_messagebox.enum_apptype.Only_OK);
                }
                else if (Program.IO.DO.Tag[(int)Config_IO.enum_do.CIR_TO_TANK_A].value == true && Program.IO.DO.Tag[(int)Config_IO.enum_do.CIR_FROM_TANK_A].value == false)
                {
                    Program.main_md.Message_By_Application("Cannot Heat Exchanger ON, Circulation Chain Fault", frm_messagebox.enum_apptype.Only_OK);
                }
                else if (Program.IO.DO.Tag[(int)Config_IO.enum_do.CIR_TO_TANK_B].value == true && Program.IO.DO.Tag[(int)Config_IO.enum_do.CIR_FROM_TANK_B].value == false)
                {
                    Program.main_md.Message_By_Application("Cannot Heat Exchanger ON, Circulation Chain Fault", frm_messagebox.enum_apptype.Only_OK);
                }
                else
                {
                    Program.schematic_form.CIRCULATION_Heat_Exchanger_ON_OFF(true);
                }
            }
        }
        private void btn_pump_bp61_Click(object sender, EventArgs e)
        {
            int idx;
            string result = "";
            DevExpress.XtraEditors.SimpleButton event_btn = (DevExpress.XtraEditors.SimpleButton)sender;
            try
            {
                ...
                switch (event_btn.Name)
                {
                    ...
                    case "btn_pump_bp61": // drain pump
                        ...
                        break;
                    case "btn_pump_bp101": // drain pump
                        idx = (int)Config_IO.enum_do.CM_Drain_Pump_On;
                        if (Program.IO.DO.Tag[idx].value == true)
                        {
                            Program.ethercat_md.DO_Write_Alone(idx, false);
                        }
                        ...
                        {
                            if (Program.IO.DO.Tag[(int)Config_IO.enum_do.CM_Drain_Tank_V_V_On].value == true || Program.IO.DO.Tag[(int)Config_IO.enum_do.CM_VAT_V_V_On].value == true)
                            {
                                Program.ethercat_md.DO_Write_Alone(idx, true);
                            }
                            else
        ...
        private void chk_use_auto_drain_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        private void chk_use_auto_cm_drain_CheckedChanged(object sender, EventArgs e)
        {
            Program.seq.monitoring.cm_use_auto_drain = chk_use_auto_cm_drain.Checked;
        }
        private void chk_use_auto_cm_drain_EditValueChanging(object sender, DevExpress.XtraEditors.Controls.ChangingEventArgs e)
        {
            if (Program.main_md.user_info.type != Module_User.User_Type.Admin && Program.main_md.user_info.type != Module_User.User_Type.User)
            {
                e.Cancel = true;
